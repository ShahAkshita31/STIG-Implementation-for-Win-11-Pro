...
Write-Host "Starting Remediation for STIG ID: WN11-CC-000030" -ForegroundColor Cyan
Write-Host "Goal: Prevent ICMP Redirects from Overriding OSPF Routes" -ForegroundColor Gray
Write-Host "------------------------------------------------------------" -ForegroundColor Cyan
