...
.USAGE
    ...
    Example syntax:
    PS C:\> .\WN11-CC-000090-remediation.ps1
#>
# Define the Registry path and value details
$regPath = "HKLM:\SOFTWARE\Policies\Microsoft\Windows\Group Policy"
$regName = "DisableBkGndGroupPolicy"
$desiredValue = 0

Write-Host "------------------------------------------------------------" -ForegroundColor Cyan
Write-Host "Starting Remediation for STIG ID: WN11-CC-000090" -ForegroundColor Cyan
Write-Host "Goal: Ensure Group Policy Objects Are Reprocessed Even If Unchanged" -ForegroundColor Gray
Write-Host "------------------------------------------------------------" -ForegroundColor Cyan
