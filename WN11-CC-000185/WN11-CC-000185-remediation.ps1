...
.USAGE
    ...
    Example syntax:
    PS C:\> .\WN11-CC-000185-remediation.ps1
#>
...
Write-Host "Starting Remediation for STIG ID: WN11-CC-000185" -ForegroundColor Cyan
Write-Host "Goal: Prevent AutoRun Commands from Executing" -ForegroundColor Gray
Write-Host "------------------------------------------------------------" -ForegroundColor Cyan
