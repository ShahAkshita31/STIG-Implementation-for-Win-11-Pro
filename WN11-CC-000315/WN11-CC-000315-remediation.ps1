...
.USAGE
    ...
    Example syntax:
    PS C:\> .\WN11-CC-000315-remediation.ps1
#>
...
Write-Host "Starting Remediation for STIG ID: WN11-CC-000315" -ForegroundColor Cyan
Write-Host "Goal: Disable 'Always Install with Elevated Privileges'" -ForegroundColor Gray
Write-Host "------------------------------------------------------------" -ForegroundColor Cyan
