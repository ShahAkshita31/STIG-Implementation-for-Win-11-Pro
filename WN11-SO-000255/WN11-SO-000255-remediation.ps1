...
.NOTES
    ...
    Documentation: https://stigaview.com/products/win11/v2r7/WN11-CC-000030/
...
.USAGE
    ...
    Example syntax:
    PS C:\> .\WN11-CC-000030-remediation.ps1
#>
...
Write-Host "Starting Remediation for STIG ID: WN11-SO-000255" -ForegroundColor Cyan
Write-Host "Goal: Automatically Deny Elevation Requests for Standard Users" -ForegroundColor Gray
Write-Host "------------------------------------------------------------" -ForegroundColor Cyan
