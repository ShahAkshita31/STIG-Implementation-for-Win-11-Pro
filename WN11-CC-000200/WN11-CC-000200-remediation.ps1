...
.NOTES
    ...
    Documentation: https://stigaview.com/products/win11/v2r7/WN11-CC-000200/
...
.USAGE
    ...
    Example syntax:
    PS C:\> .\WN11-CC-000200-remediation.ps1
#>
...
Write-Host "Starting Remediation for STIG ID: WN11-CC-000200" -ForegroundColor Cyan
Write-Host "Goal: Prevent Enumeration of Administrator Accounts During Elevation" -ForegroundColor Gray
Write-Host "------------------------------------------------------------" -ForegroundColor Cyan
